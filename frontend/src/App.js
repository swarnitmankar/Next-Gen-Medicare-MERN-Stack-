...
import BloodPressure from "./screens/bloodPressureScreen"
    ...
    <Router>
      ...
      <main className="app">
        <Switch>
          ...
          <Route exact path="/products/bloodPressure"component={BloodPressure}/>
          ...
          <Route exact path="/Sucess" component={SuccessScreen} />
